...
void ST7735_DrawBitmap(int16_t x, int16_t y, const unsigned short *image, int16_t w, int16_t h){
...
unsigned long ST7735_DrawString(unsigned short x, unsigned short y, char *pt, short textColor){
...
// Outputs: none
void ST7735_PlotPoint(long y){int32_t j;
  if(y<Ymin) y=Ymin;
  if(y>Ymax) y=Ymax;
...
// Outputs: none
int32_t lastj=0;
void ST7735_PlotLine(long y){int32_t i,j;
  if(y<Ymin) y=Ymin;
  if(y>Ymax) y=Ymax;
  // X goes from 0 to 127
  // j goes from 159 to 32
...
// Outputs: none
void ST7735_PlotPoints(long y1,long y2){int32_t j;
  if(y1<Ymin) y1=Ymin;
  if(y1>Ymax) y1=Ymax;
  // X goes from 0 to 127
  // j goes from 159 to 32
...
// Input:  16-bit packed color
// Output: none
void Output_Color(unsigned long newColor){ // Set color of future output 
