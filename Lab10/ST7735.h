...
// Outputs: none
void ST7735_PlotPoints(long y1,long y2);
...
// Output: none
// ********************************************************
void ST7735_SetTextColor(unsigned short color);
...
// Input:  16-bit packed color
// Output: none
void Output_Color(unsigned long newColor); 
