...
/* This example accompanies the book
 ...
 Copyright 2013-2014 by Jonathan W. Valvano, valvano@mail.utexas.edu
...
const unsigned char InputPortMsg[40] = "PE0 is input";
const unsigned char OutputPortMsg[40] = "PE1 is output+Scope on PA1-0";
...
const unsigned char InitializedMsg[40] = "TExaS is initialized for Lab 4";
...
// Outputs: none
void TExaS_Init(void){volatile unsigned long delay;
  ...
  ScopeCount = 0;
  TExaS_Ports.InputPort = (unsigned long) InputPortMsg;  // PE0
  TExaS_Ports.OutputPort = (unsigned long) OutputPortMsg;
  ScopeMode = 1;
